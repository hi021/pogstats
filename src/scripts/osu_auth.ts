import { OSU_CLIENT_ID, OSU_CLIENT_SECRET, SIMULATE_OSU_OUTAGE } from "../env.js";
import { timedFetch } from "../metrics.js";
import { AUTH_ENDPOINT, USER_AGENT } from "./shared.js";

export async function getOAuthToken(grantType = "client_credentials", code?: string) {
	if (SIMULATE_OSU_OUTAGE)
		throw new Error("'SIMULATE_OSU_OUTAGE' environment variable is set to true, refusing API connection");
